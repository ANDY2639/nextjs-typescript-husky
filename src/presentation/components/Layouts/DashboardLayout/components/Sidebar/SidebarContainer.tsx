...
import { EcommerceIcon, HouseIcon, OrdersIcon, ProductsIcon, UsersIcon } from "@/presentation/components/Icons";
...
const SidebarContainer: React.FC<SidebarContainerProps> = ({ setIsSidebarOpen }) => {
  ...
  const menuItems = [
    ...
    { name: "Usuarios", path: "/users", icon: UsersIcon },
    {
      ...
      path: "/ecommerce",
      icon: EcommerceIcon,
      submenu: [{ name: "Productos", path: "/ecommerce/products", icon: ProductsIcon }],
    },
